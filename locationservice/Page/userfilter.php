...
<div class="content">
	<h2 style="font-size:40px">User location history</h2>
...
<table id="users">
    ...
    if(isset($_POST['display_btn']))
    {
			...
			$userIDresult = mysqli_query($conn,$userlocationsquery);
			while($rows = mysqli_fetch_array($userIDresult, MYSQLI_ASSOC))
        	{
            echo '<tr>
